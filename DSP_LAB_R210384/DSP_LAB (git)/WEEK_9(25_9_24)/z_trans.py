...
z = sp.symbols('z', complex=True)  #by sympy we can initialise a variable , without a value can use
...
def compute_z_transform(sequence, n_var, L):
    ...
    Z = sp.summation(sequence * z**(-n_var), (n_var, 0, L) )  # n_var =0 to inf
...
plot_zeros_poles(zeros,poles)  #def funct
